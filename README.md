...
be deprecated at the end 2018, the newest version ('helix') is not fully implemented yet
...
setting the query parameter `?login=<login-name>` and the field 
...
`localhost:8080/?login=kdmarrett&info=bio`
...
`localhost:8080/?login=<login-name>&info=views`

#### User channel # of followers

`localhost:8080/?login=<login-name>&info=followers`

#### User channel game name

`localhost:8080/?login=<login-name>&info=game`

#### User channel language

`localhost:8080/?login=<login-name>&info=language`

#### User currently streaming status

`localhost:8080/?login=<login-name>&info=streaming`

#### User display name

`localhost:8080/?login=<login-name>&info=display_name`

#### User bio

`localhost:8080/?login=<login-name>&info=bio`

#### User account creation date

`localhost:8080/?login=<login-name>&info=creation`
